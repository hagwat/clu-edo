...
public class TextClient {
	...
	public void playerRefute(String wep, String room, String person, Player p){
		...
		System.out.println("You accused a card that was in your own hand! ");	//Has checked all other players hands, deck and solution, must be in accusing player's hand
	}
